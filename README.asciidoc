...
** [NEW] インタースティシャル（全画面）広告のバグ対応（クラッシュレポート対応）
** [NEW] PreRoll広告に対応しました。
...
- link:Samples/Eclipse/AMoAdBannerSample[Eclipse版]
- link:Samples/AndroidStudio/AMoAdBannerSample[AndroidStudio版]

サンプルコード(インタースティシャル)::
管理画面から取得したsidを入力して動かしてください
- link:Samples/Eclipse/AMoAdInterstitialSample[Eclipse版]
- link:Samples/AndroidStudio/AMoAdInterstitialSample[AndroidStudio版]
...
* Eclipse版
** link:Samples/Eclipse/AMoAdNativeAppTextSample/[テキスト広告]
** link:Samples/Eclipse/AMoAdNativeAppIconTextSample/[アイコンテキスト広告]
** link:Samples/Eclipse/AMoAdNativeAppImageTextSample/[メイン画像テキスト広告]

* AndroidStudio版
** link:Samples/AndroidStudio/AMoAdNativeAppTextSample/[テキスト広告]
** link:Samples/AndroidStudio/AMoAdNativeAppIconTextSample/[アイコンテキスト広告]
** link:Samples/AndroidStudio/AMoAdNativeAppImageTextSample/[メイン画像テキスト広告]
...
* Eclipse版
** link:Samples/Eclipse/AMoAdNativeListViewTextSample/[テキスト広告]
** link:Samples/Eclipse/AMoAdNativeListViewIconTextSample/[アイコンテキスト広告]
** link:Samples/Eclipse/AMoAdNativeListViewImageTextSample/[メイン画像テキスト広告]

* AndroidStudio版
** link:Samples/AndroidStudio/AMoAdNativeListViewTextSample/[テキスト広告]
** link:Samples/AndroidStudio/AMoAdNativeListViewIconTextSample/[アイコンテキスト広告]
** link:Samples/AndroidStudio/AMoAdNativeListViewImageTextSample/[メイン画像テキスト広告]
...
AMoAd SDKでは、プリロール広告を簡単に表示するAPIを提供しています
 ...
 サンプルコード::
 管理画面から取得したsidを入力して動かしてください
- link:Samples/Eclipse/AMoAdPreRollSample/[Eclipse版]
- link:Samples/AndroidStudio/AMoAdPreRollSample/[AndroidStudio版]
